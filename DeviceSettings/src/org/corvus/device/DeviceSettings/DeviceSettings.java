...
import org.corvus.device.DeviceSettings.preferences.VibratorNotifStrengthPreference;
import org.corvus.device.DeviceSettings.preferences.VibratorStrengthPreference;
import org.corvus.device.DeviceSettings.thermal.ThermalActivity;
...
public class DeviceSettings extends PreferenceFragment
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mFpsInfo) {
            ...
            Intent fpsinfo = new Intent(this.getContext(), org.corvus.device.DeviceSettings.FPSInfoService.class);
            if (enabled) {
